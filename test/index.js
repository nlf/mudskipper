...
describe('mudskipper', function () {
    it('doesn\'t blow up of you don\'t pass resources on load', function (done) {
    ...
    it('allows a plugin to add resources via api', function (done) {

        server.pack.register(require('./plugin'), null, function (err) {
