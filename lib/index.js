...
internals.addResource = function _addResource(pack, name, resource, parents, parentsettings) {
    ...
    if (resource.hasOwnProperty('basePath')) name = resource.basePath;
    var path;
    var route;
    var settings;
    ...
    Object.keys(resource).forEach(function _eachMethod(method) {
        ...
        if (method === 'children' || method === 'basePath') return;
    ...
    if (resource.children) {
        ...
        resource.children.forEach(function _eachChild(child) {
            ...
            if (typeof child === 'string') {
                ...
                internals.addResource(pack, child, Hoek.clone(internals.top[child]), newparents, newparentsettings);
            } else {
